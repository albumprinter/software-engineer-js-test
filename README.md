...
be sure to write your own logic for the photo-to-print conversion!
...
automatically generated by the build script and can be ignored.
...
In the root of this repository, you can resolve all dependencies via
command line using:
